...
- [Memoria Técnica y Guía de Ejecución](#memoria-técnica-y-guía-de-ejecución)
  - [📋 Índice](#-índice)
  ...
  - [3. Diseño de Base de Datos](#3-diseño-de-base-de-datos)
    ...
    - [Entidad: Transaction](#entidad-transaction)
  - [4. Manejo de Errores](#4-manejo-de-errores)
  - [5. Validación y Cobertura de Tests](#5-validación-y-cobertura-de-tests)
  ...
  - [6. Instrucciones de Ejecución y Entorno](#6-instrucciones-de-ejecución-y-entorno)
    ...
    - [6.3. Comandos de Gestión (Docker + App)](#63-comandos-de-gestión-docker--app)
      ...
      - [Ejecutar Pruebas (Automático)](#ejecutar-pruebas-automático)
      - [Generar Ejecutable (Producción)](#generar-ejecutable-producción)
      - [Limpieza](#limpieza)
